    ...
    <div class="container">
        ...
        <form action="index.php" method="get">
            ...
            <select name="program_studi" id="program_studi" onchange="this.form.submit()">
                ...
                <option value="Sains Data" <?php echo ($program_studi == 'Sains Data') ? 'selected' : ''; ?>>Sains Data</option>
                <option value="Matematika" <?php echo ($program_studi == 'Matematika') ? 'selected' : ''; ?>>Matematika</option>
            </select>
        </form>
